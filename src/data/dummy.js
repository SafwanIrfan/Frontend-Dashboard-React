...
export const EditorData = () => (
   <div>
      <h3>
         ...
         page, or start a complex React-powered app, the links in this section
         will help you get started. Online Playgrounds If you’re interested in
         playing around with React, you can use an online code playground. Try a
         Hello World template on CodePen, CodeSandbox, or Stackblitz. If you
         prefer to use your own text editor, you can also download this HTML
         file, edit it, and open it from the local filesystem in your browser.
         It does a slow runtime code transformation, so we’d only recommend
         using this for simple demos. Add React to a Website You can add React
         to an HTML page in one minute. You can then either gradually expand its
         presence, or keep it contained to a few dynamic widgets. Create a New
         React App When starting a React project, a simple HTML page with script
         tags might still be the best option. It only takes a minute to set up!
         ...
         with a live editor. Even if you don’t know anything about React yet,
         ...
         pace than you’re comfortable with, check out this overview of React by
         ...
         documentation another try! React for Designers If you’re coming from a
         design background, these resources are a great place to get started.
         JavaScript Resources The React documentation assumes some familiarity
         with programming in the JavaScript language. You don’t have to be an
         expert, but it’s harder to learn both React and JavaScript at the same
         time. We recommend going through this JavaScript overview to check your
...
export const kanbanData = [
   ...
   },
   {
      ...
      Title: "Task - 29007",
      Status: "idate",
      Summary: "idate new requirements",
      Type: "Improvement",
      Priority: "Low",
      Tags: "idation",
      Estimate: 1.5,
   ...
   },
   {
      ...
      Title: "Task - 29011",
      Status: "idate",
      Summary: "idate the issues reported by the customer.",
      Type: "Story",
      Priority: "High",
      Tags: "idation,Fix",
      Estimate: 1,
   ...
   },
   {
      ...
      Title: "Task - 29019",
      Status: "idate",
      Summary: "idate databinding issues.",
      Type: "Story",
      Priority: "Low",
      Tags: "idation",
      Estimate: 1.5,
